...
def clean_text(text: str) -> str:
    """
    Very light cleaning step for now.
    You can expand this later (remove extra spaces, weird characters, etc.).
    """
...
if __name__ == "__main__":
    # Quick smoke test: load a tiny subset and print an example
